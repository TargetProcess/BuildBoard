...
import models.branches.{Branch, BranchRepositoryComponentImpl}
import models.{Build, BuildRepositoryComponentImpl}
  ...
  "BranchesRepositoryImpl" should {
    "return last build" in context {
      running(context.fakeApp) {
        ...
        repo.buildRepository.getAllBuilds.size must_== 0
        ...
        repo.buildRepository.getAllBuilds.size must_== 4
